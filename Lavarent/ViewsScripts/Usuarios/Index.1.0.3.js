    ...
    var tUsuarios = $('#dtUsuarios').TablaDeDatos({
        ...
        fnRowCallback: function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
            ...
            if (_usuario_activo == 1) {
                btnActivo = '<button data-id ="' + _guid_usuario + '" class="btnActivoRapido btn blue">Activo​</button>';
            }
            else {
                btnActivo = '<button data-id ="' + _guid_usuario + '" class="btnActivoRapido btn red">Inactivo</button>';
            }
